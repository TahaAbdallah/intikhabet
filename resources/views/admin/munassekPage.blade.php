...
<div class="container row align-items-center justify-content-around m-auto main-cont">
    ...
    <a class="adding-btn" href="{{ route('admin.addMunassekPage') }}">اضافة منسّق<i class="fa fa-plus"
            ...
            <tbody>
                <tr>
                    ...
                    <td class="delete-without-border-td">
                        <p><a data-toggle="modal" data-target="#munassekModel"><i class="fa fa-times"
                                    aria-hidden="true"></i></a>
                        </p>
                    </td>
                </tr>
...
<!-- munassek modal -->
<div class="modal fade text-center" id="munassekModel" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"> هل فعلا تريد ازالة هذا المنسّق ؟</h5>
