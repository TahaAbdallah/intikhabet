...
<div class="container row align-items-center justify-content-around m-auto main-cont">
    ...
    <a class="adding-btn" href="{{ route('admin.addMandubSebetPage') }}">اضافة مندوب ثابت<i class="fa fa-plus"
...
<div class="container">
    ...
    {{-- ## START TABLE 1 ## --}}
    <div class="container">
        <h5 class="table-title">المندوبين الثابتين</h5>
