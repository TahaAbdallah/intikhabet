...
<div class="container row align-items-center justify-content-around m-auto main-cont">
    ...
    <a class="adding-btn" href="{{ route('admin.addDataEntryPage') }}">Data Entry اضافة<i class="fa fa-plus"
...
<div class="container">
    ...
    {{-- ## START TABLE 1 ## --}}
    <div class="container">
        <h5 class="table-title">Data Entry</h5>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="delete-without-border-td">
                        <p><a data-toggle="modal" data-target="#dataEntryModel"><i class="fa fa-times"
                                    aria-hidden="true"></i></a>
                        </p>
                    </td>
                </tr>
...
<!-- data entry modal -->
<div class="modal fade text-center" id="dataEntryModel" tabindex="-1" role="dialog" aria-labelledby="modelTitleId"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"> هل فعلا تريد ازالة هذا Data Entry ؟</h5>
