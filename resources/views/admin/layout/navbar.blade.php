...
<body>
            ...
            <div>
                <div class="row align-items-center">
                    <div class="text-right">
                        <a href="{{ route('admin.profilePage') }}" class="p-0 m-0 profile-name">{{ auth()->user()->name
                            }}</a>
            ...
            <div class="nav-2 row container-fluid justify-content-center" id="nav-2">
                ...
                <div class="nav-2-tables">
                    ...
                    <div class="nav-2-tables-content">
                        <a href="{{ route('admin.dataEntryPage') }}">Data Entry</a>
                        <a href="{{ route('admin.murakebPage') }}">المراقبين</a>
                        <a href="{{ route('admin.mandoubMutajawwelPage') }}">المندوبين المتجولين</a>
                        <a href="{{ route('admin.mandoubSebetPage') }}">المندوبين الثابتين</a>
                        <a href="{{ route('admin.munassekPage') }}">المنسقين</a>
                    </div>
                </div>
                ...
                <div class="nav-2-tables">
                    <p>لوائح الشّطب</p>
                    <div class="nav-2-tables-content">
                        <a href="{{ route('admin.alMuntakhibinPage') }}">المنتخِبين</a>
                        <a href="{{ route('admin.lamYantakhibouPage') }}">لم ينتخبوا بعد</a>
                    </div>
                </div>

                <div class="nav-2-tables">
                    <p>اللّوائح والمرشّحين</p>
                    <div class="nav-2-tables-content">
                        <a href="{{ route('admin.lawaeh') }}">جميع اللّوائح</a>
                        <a href="">اضافة لائحة</a>
                        <a href="">اضافة مرشّح</a>
                    </div>
                </div>
    ...
    <script type="text/javascript" src="{{ URL::asset('js/haselEntikhabi.js') }}"></script>
